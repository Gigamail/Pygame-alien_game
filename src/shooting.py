...
Enemy_missile1=pygame.image.load("images\\pixel_laser_red.png").convert()
Enemy_missile2=pygame.image.load("images\\pixel_laser_blue.png").convert()
Enemy_missile3=pygame.image.load("images\\pixel_laser_green.png").convert()
#ememys spaceplayer
...
class Player(Ship):
    def __init__(self, x, y, health=100):
        ...
        self.ship_img = MYSPACE
        self.laser_img = MISSILE
...
class Enemy(Ship):
    COLOR_MAP = {
                "red": (ALIEN1,Enemy_missile1),
                "green": (ALIEN3,Enemy_missile3),
                "blue": (ALIEN2,Enemy_missile2)
                }
...
def main():
    ...
    while run:
        ...
        if keys[pygame.K_DOWN] and player.y + player_vel + player.get_height() + 15 < HEIGHT: # down
            player.y += player_vel
        if keys[pygame.K_SPACE]:# TO SHOOT
            player.shoot()
